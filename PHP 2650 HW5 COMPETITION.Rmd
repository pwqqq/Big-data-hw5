...
bst <- xgboost(data =sparse_matrix , label = output_vector, max.depth =10, 
                     eta = 0.01, nthread = 2, nround = 200, objective = "binary:logistic",eval_metric="logloss")
...
test2 <- test2[,-1] # delete ID column
